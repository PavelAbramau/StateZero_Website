    ...
    <main className="relative min-h-screen text-[#F4F4FB] overflow-x-hidden">
      <div className="flex flex-col">
        ...
        <section className="py-32 sm:py-40 flex flex-col items-center text-center px-6">
          ...
          {/* Primary CTA */}
          <a
            href="mailto:pavel@statezerolabs.com?subject=Data%20Room%20Access%20Request&body=Hi%20Pavel,%20I%20would%20like%20to%20request%20access%20to%20the%20StateZero%20investor%20data%20room."
          ...
          {/* Secondary link */}
          <a
            href="mailto:hello@statezero.io"
